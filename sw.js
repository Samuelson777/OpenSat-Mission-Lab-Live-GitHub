const CACHE='opensat-live-v1';
const ASSETS=['./','index.html','404.html','manifest.webmanifest','assets/css/styles.css','assets/js/data.js','assets/js/charts.js','assets/js/app.js','assets/images/favicon.svg'];
